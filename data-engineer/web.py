...
def process_row(row, writer):
    ...
    # Validate correct_ans_num and check_radio
    if not correct_ans_num or correct_ans_num not in ['1', '2', '3', '4', '5', '6']:
        correct_ans_num = ''  # Reset to empty if invalid
    if check_radio not in ['radio', 'check']:
        check_radio = ''  # Reset to empty if invalid
...
# Usage
input_file = 'engineer.csv'
output_file = 'engineer_fixed.csv'
